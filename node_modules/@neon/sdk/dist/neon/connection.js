...
function withConnectionString(result, uris, build, pooled) {
	...
	if (!connectionString) return err(new NeonClientError("The response did not include a connection URI (the branch or project may have multiple roles or databases). Use `raw.getConnectionUri` with an explicit role and database."));
