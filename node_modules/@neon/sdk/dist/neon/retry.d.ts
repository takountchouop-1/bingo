 ...
 */
declare function resolveRetries(retries: number | undefined): number;
/**
...
//#endregion
export { MAX_RETRY_WAIT_MS, RawOutcome, backoffMs, nextRetryDelayMs, parseRetryAfterMs, resolveRetries, withRetries };
