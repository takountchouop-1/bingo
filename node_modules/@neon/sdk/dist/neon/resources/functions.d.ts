...
declare class Functions<DThrow extends boolean> {
  ...
  list(projectId: string, branchId: string, query?: ListQuery): Paginated<NeonFunction, DThrow>;
  list<Throw extends boolean = DThrow>(projectId: string, branchId: string, query: ListQuery | undefined, opts: CallOptions<Throw>): Paginated<NeonFunction, Throw>;
