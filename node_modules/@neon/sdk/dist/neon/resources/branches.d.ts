...
declare class Branches<DThrow extends boolean> {
  ...
  list<Throw extends boolean = DThrow>(projectId: string, query: ListQuery | undefined, opts: CallOptions<Throw>): Paginated<Branch, Throw>;
