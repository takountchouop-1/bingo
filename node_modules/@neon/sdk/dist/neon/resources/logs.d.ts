...
declare class Logs<DThrow extends boolean> {
   ...
   */
  query(projectId: string, branchId: string, input?: LogQueryInput): Paginated<ProjectBranchLogRecord, DThrow>;
  query<Throw extends boolean = DThrow>(projectId: string, branchId: string, input: LogQueryInput | undefined, opts: CallOptions<Throw>): Paginated<ProjectBranchLogRecord, Throw>;
  /**
