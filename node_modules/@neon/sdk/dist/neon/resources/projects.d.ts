...
declare class Members<DThrow extends boolean> {
   ...
   */
  list(projectId: string, query?: MemberListQuery): Paginated<ProjectMember, DThrow>;
  list<Throw extends boolean = DThrow>(projectId: string, query: MemberListQuery | undefined, opts: CallOptions<Throw>): Paginated<ProjectMember, Throw>;
  /**
...
declare class Projects<DThrow extends boolean> {
  ...
  list<Throw extends boolean = DThrow>(query: ListQuery | undefined, opts: CallOptions<Throw>): Paginated<ProjectListItem, Throw>;
