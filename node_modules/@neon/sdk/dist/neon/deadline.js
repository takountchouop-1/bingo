import { NeonAbortError, NeonClientError, NeonRequestTimeoutError } from "./errors.js";
...
function cancelled(deadline) {
	...
	if (source === "timeout") {
		...
		if (timeoutMs === void 0) throw new NeonClientError("Internal: a request timeout fired without a requestTimeoutMs budget.");
		return new NeonRequestTimeoutError("Timed out waiting for the Neon API to respond (requestTimeoutMs).", { timeoutMs });
	}
}
/**
...
function createDeadline(timeoutMs, callerSignal) {
	...
	return {
		...
		timeoutMs: bounded ? timeoutMs : void 0,
		remainingMs,
		source: () => {
