...
function resolveRetries(retries) {
	if (retries === void 0) return DEFAULT_RETRIES;
	if (typeof retries !== "number" || !Number.isInteger(retries) || retries < 0) throw new NeonError(`retries must be a non-negative integer; received ${String(retries)}.`, "client");
	return retries;
}
/**
...
//#endregion
export { MAX_RETRY_WAIT_MS, backoffMs, nextRetryDelayMs, parseRetryAfterMs, resolveRetries, withRetries };
